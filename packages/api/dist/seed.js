...
function seed() {
    ...
    const existing = db_1.default.prepare('SELECT COUNT(*) as count FROM users').get();
    if (existing.count > 0) {
    ...
    const insertUser = db_1.default.prepare(`INSERT INTO users (id, sso_subject, email, display_name, role, region, created_at, updated_at)
    ...
    const insertMethod = db_1.default.prepare(`INSERT INTO methods (id, name, description, required_material, is_active, created_at, updated_at)
    ...
    const insertLab = db_1.default.prepare(`INSERT INTO labs (id, name, region, contact_info, is_active, created_at, updated_at)
    ...
    const insertLabMethod = db_1.default.prepare(`INSERT INTO lab_methods (lab_id, method_id) VALUES (@lab_id, @method_id)`);
